...
function getCalendarByRange($id) {
    try {
        ...
        $sql = $pdo->prepare('SELECT * FROM `jqcalendar` WHERE `id` = ?');
        $sql->execute(array(
            $id
        ));
...
<html>
    <head>    
        ...
        <link type="text/css" href="css/dp.css" rel="stylesheet">    
        <link type="text/css" href="css/dropdown.css" rel="stylesheet">    
        <link type="text/css" href="css/colorselect.css" rel="stylesheet">   
